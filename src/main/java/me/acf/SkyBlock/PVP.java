...
public class PVP extends MiniPlugin {
	...
	public void Morte(final PlayerDeathEvent event)
	{
	  ...
	  public void AddLogKill(Player p, Player k)
	  {
		     Conta.AddMatou(k);
		     Conta.Reload(k);
		     Config.addn(p.getPlayer(), "skyblock.morreu." + k.getName(), "0");
		     Config.addn(k, "skyblock.matou." + p.getName(), "0");
		     int morreu = Integer.parseInt(Config.retornar(p, "skyblock.morreu." + k.getName()))+1;
		     Config.Set(p.getPlayer(), "skyblock.morreu." + k.getName(), "" + morreu);
		     int matou = Integer.parseInt(Config.retornar(k, "skyblock.matou." + p.getName()))+1;
		     Config.Set(k.getPlayer(), "skyblock.matou." + p.getName(), "" + matou);
