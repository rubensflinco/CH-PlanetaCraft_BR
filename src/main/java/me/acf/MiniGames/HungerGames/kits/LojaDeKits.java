	     ...
	     if (Kit.kit.containsKey(NomeKIT))
	    		 {
 	    	       ...
 	    	       p.closeInventory();
			  	   ...
			  	   String buscar = AccountWeb.Conectar(Main.site + "/API/MG/HG.php?modo=LOJA-Kit&nick="+p.getName()+"&quantidade="+Kit.kitsLOJApreco.get(NomeKIT)+"&kit="+NomeKIT.replace("§9", "")+"", "KIT");
