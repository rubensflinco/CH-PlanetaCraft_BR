...
import me.acf.MiniGames.OneInTheChamber.Conta;
import me.hub.Main;
	     ...
	     if (Kit.kit.containsKey(NomeKIT))
	    		 {
 	    	       ...
 	    	       p.closeInventory();
			  	   ...
			  	   String buscar = AccountWeb.Conectar(Main.site + "/API/MG/OITC.php?modo=LOJA-Kit&nick="+p.getName()+"&quantidade="+Kit.kitsLOJApreco.get(NomeKIT)+"&kit="+NomeKIT.replace("§9", "")+"", "KIT");
