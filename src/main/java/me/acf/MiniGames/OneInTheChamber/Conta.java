...
public class Conta {
	...
	{
		try {
	 	JSONObject json = new JSONObject(AccountWeb.Conectar(Main.site + "/API/MG/OITC.php?modo=VER-conta&nick=" + p.getName()));
	...
	{
	 	JSONObject json = new JSONObject(AccountWeb.Conectar(Main.site + "/API/MG/OITC.php?modo=VER-conta&nick=" + p));
	...
	{
		System.out.print(AccountWeb.Conectar(Main.site + "/API/MG/OITC.php?modo=ADD-matou&nick=" + p.getName()));
	}
	public static void AddMorreu(Player p)
	{
		System.out.print(AccountWeb.Conectar(Main.site + "/API/MG/OITC.php?modo=ADD-morreu&nick=" + p.getName()));
	}
}
