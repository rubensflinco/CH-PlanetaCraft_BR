...
public class Scoreboard {
	 ...
	 public static void UpdateScoreboard()
	 {
		 ...
		 for (Player player : Bukkit.getOnlinePlayers()) {
	        ...
	        ScoreboardAPI.add("Nivel:§a " + Account.getNivel(player)); //10
	        ScoreboardAPI.add("Patente: " + Account.getPatente(player).GetTag(false)); //9
	        ScoreboardAPI.add("§f"); //8    
	        ScoreboardAPI.add("Chaves: §c" + Account.getChave(player)); //7
	        ...
	        ScoreboardAPI.add("Evento: §aNenhum"); //3
