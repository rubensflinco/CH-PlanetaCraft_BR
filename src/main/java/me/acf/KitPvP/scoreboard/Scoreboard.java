package me.acf.KitPvP.scoreboard;
...
public class Scoreboard {
	  ...
	  public static String texto = "§f§lKitPvP §6§lPC-BR";
	 ...
	 public static void UpdateScoreboard()
	 {
		 ...
		 for (Player player : Bukkit.getOnlinePlayers()) {
	        ...
	        ScoreboardAPI.add("Seu Kit atualmente: §a" + Kit.verkit(player)); //6
