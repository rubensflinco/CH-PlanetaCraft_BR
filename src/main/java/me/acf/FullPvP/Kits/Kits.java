...
public class Kits extends MiniPlugin {
	...
	public void KitIniciante()
	{
	    Inventory pvp = Bukkit.createInventory(null, 54, "KitIniciante");
	    ...
	    KitAPI.AddKit("iniciante", pvp);
	}
	
	public void KitPvP()
	{
	    Inventory pvp = Bukkit.createInventory(null, 54, "KitPvP");
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_SWORD, 2, (byte) 0, "", "§6§lKit PVP"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.IRON_HELMET, 2, (byte) 0, "", "§6§lKit PVP"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.IRON_CHESTPLATE, 2, (byte) 0, "", "§6§lKit PVP"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.IRON_LEGGINGS, 2, (byte) 0, "", "§6§lKit PVP"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.IRON_BOOTS, 2, (byte) 0, "", "§6§lKit PVP"));
	    KitAPI.AddKit("pvp", pvp);
	}
	public void KitNB()
	{
	    Inventory pvp = Bukkit.createInventory(null, 54, "KitNB");
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_SWORD, 1, (byte) 0, "", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_PICKAXE, 1, (byte) 0, "", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_AXE, 1, (byte) 0, "", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_SPADE, 1, (byte) 0, "", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_HOE, 1, (byte) 0, "", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_CHESTPLATE, 1, (byte) 0, "", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_LEGGINGS, 1, (byte) 0, "", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_BOOTS, 1, (byte) 0, "", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.BEACON, 50, (byte) 0, "§a§lComida", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.APPLE, 50, (byte) 0, "§a§lComida", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.CAKE, 50, (byte) 0, "§a§lComida", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_BLOCK, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.GOLD_BLOCK, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.IRON_BLOCK, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.NETHER_BRICK, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.NETHER_STAR, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.OBSIDIAN, 50, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.WOOL, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.ENDER_CHEST, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.ENDER_PEARL, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.ARMOR_STAND, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.BLAZE_POWDER, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.SLIME_BLOCK, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.SLIME_BALL, 10, (byte) 0, "§a§lBlocos", "§6§lKit NB"));
	    KitAPI.AddKit("§anb", pvp);
	}
	public void KitBlocos()
	{
	    Inventory pvp = Bukkit.createInventory(null, 54, "KitBlocos");
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_BLOCK, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.GOLD_BLOCK, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.IRON_BLOCK, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.NETHER_BRICK, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.NETHER_STAR, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.OBSIDIAN, 50, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.WOOL, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.ENDER_CHEST, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.ENDER_PEARL, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.ARMOR_STAND, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.BLAZE_POWDER, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.SLIME_BLOCK, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.SLIME_BALL, 10, (byte) 0, "§a§lBlocos", "§6§lKit Blocos"));
	    KitAPI.AddKit("§ablocos", pvp);
	}
	public void KitComida()
	{
	    Inventory pvp = Bukkit.createInventory(null, 54, "KitComida");
	    pvp.addItem(UtilInv.AddItemReturn(Material.BEACON, 50, (byte) 0, "§a§lComida", "§6§lKit Comida"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.APPLE, 50, (byte) 0, "§a§lComida", "§6§lKit Comida"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.GOLDEN_APPLE, 50, (byte) 0, "§a§lComida", "§6§lKit Comida"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.GOLDEN_APPLE, 50, (byte) 1, "§a§lComida", "§6§lKit Comida"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.CAKE, 50, (byte) 0, "§a§lComida", "§6§lKit Comida"));
	    KitAPI.AddKit("§acomida", pvp);
	}
	public void KitVIP()
	{
	    Inventory pvp = Bukkit.createInventory(null, 54, "KitVIP");
	    Random r = new Random();
	    pvp.addItem(AddSwordEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_SWORD, 10, (byte) 0, "§a§lEspada de DIAMOND", "§6§lKit VIP"), 59));
	    pvp.addItem(AddSwordEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_AXE, 10, (byte) 0, "§a§lMachado de DIAMOND", "§6§lKit VIP"), 59));
	    pvp.addItem(AddArmorEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_HELMET, 10, (byte) 0, "§a§lCapacete de DIAMOND", "§6§lKit VIP"), 59));
	    pvp.addItem(AddArmorEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_CHESTPLATE, 10, (byte) 0, "§a§lPeitoral de DIAMOND", "§6§lKit VIP") ,59));
	    pvp.addItem(AddArmorEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_LEGGINGS, 10, (byte) 0, "§a§lCalça de DIAMOND", "§6§lKit VIP"), 59));
	    pvp.addItem(AddArmorEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_BOOTS, 10, (byte) 0, "§a§lBota de DIAMOND", "§6§lKit VIP"), 59));
	    pvp.addItem(AddUtilEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_PICKAXE, 10, (byte) 0, "§a§lPicareta de DIAMOND", "§6§lKit VIP"), 20));
	    pvp.addItem(AddUtilEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_HOE, 10, (byte) 0, "§a§lPá de DIAMOND", "§6§lKit VIP"), 20));
	    pvp.addItem(AddBowEnchantRandom(UtilInv.AddItemReturn(Material.BOW, 10, (byte) 0, "§a§lArco", "§6§lKit VIP"), 40));
	    ...
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_BLOCK, 64, (byte) 0, "§a§lBlocos", "§6§lKit VIP"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.GOLD_BLOCK, 64, (byte) 0, "§a§lBlocos", "§6§lKit VIP"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.IRON_BLOCK, 64, (byte) 0, "§a§lBlocos", "§6§lKit VIP"));
	...
	public void KitVIPM()
	{
	    Inventory pvp = Bukkit.createInventory(null, 54, "KitVIP+");
		Random r = new Random();
	    pvp.addItem(AddSwordEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_SWORD, 10, (byte) 0, "§a§lEspada de DIAMOND", "§6§lKit VIP"), 70));
	    pvp.addItem(AddSwordEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_AXE, 10, (byte) 0, "§a§lMachado de DIAMOND", "§6§lKit VIP"), 70));
	    pvp.addItem(AddArmorEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_HELMET, 10, (byte) 0, "§a§lCapacete de DIAMOND", "§6§lKit VIP"), 70));
	    pvp.addItem(AddArmorEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_CHESTPLATE, 10, (byte) 0, "§a§lPeitoral de DIAMOND", "§6§lKit VIP") ,70));
	    pvp.addItem(AddArmorEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_LEGGINGS, 10, (byte) 0, "§a§lCalça de DIAMOND", "§6§lKit VIP"), 70));
	    pvp.addItem(AddArmorEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_BOOTS, 10, (byte) 0, "§a§lBota de DIAMOND", "§6§lKit VIP"), 70));
	    pvp.addItem(AddUtilEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_PICKAXE, 10, (byte) 0, "§a§lPicareta de DIAMOND", "§6§lKit VIP"), 29));
	    pvp.addItem(AddUtilEnchantRandom(UtilInv.AddItemReturn(Material.DIAMOND_HOE, 10, (byte) 0, "§a§lPá de DIAMOND", "§6§lKit VIP"), 29));
	    pvp.addItem(AddBowEnchantRandom(UtilInv.AddItemReturn(Material.BOW, 10, (byte) 0, "§a§lArco", "§6§lKit VIP"), 50));
	    pvp.addItem(UtilInv.AddItemReturn(Material.ARROW, r.nextInt(120), (byte) 1, "§a§lFlexa", "§6§lKit VIP"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.GOLDEN_APPLE, r.nextInt(500), (byte) 1, "§a§lMaçã Dourada", "§6§lKit VIP"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.BEDROCK, r.nextInt(500), (byte) 1, "§a§lBedRock", "§6§lKit VIP"));
	    pvp.addItem(UtilInv.AddItemReturn(Material.DIAMOND_BLOCK, 64, (byte) 0, "§a§lBlocos", "§6§lKit VIP"));
